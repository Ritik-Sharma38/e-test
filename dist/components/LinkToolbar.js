...
class LinkToolbar extends React.Component {
    ...
    render() {
        const _a = this.props, { onCreateLink, onClose, view, linkToolBarRef, mobile } = _a, rest = __rest(_a, ["onCreateLink", "onClose", "view", "linkToolBarRef", "mobile"]);
        const { selection } = this.props.view.state;
        const active = isActive(this.props);
        return (React.createElement(FloatingToolbarTemp_1.default, Object.assign({ view: view, ref: this.menuRef, active: active }, rest, { fromCommandMenu: active }), active && (React.createElement(LinkEditor_1.default, Object.assign({ view: view, ref: linkToolBarRef, from: selection.from, to: selection.to, onCreateLink: onCreateLink ? this.handleOnCreateLink : undefined, onSelectLink: this.handleOnSelectLink, onRemoveLink: onClose, fromCommandMenu: true, mobile: mobile }, rest)))));
    }
}
