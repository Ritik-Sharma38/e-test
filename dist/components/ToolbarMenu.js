...
const ToolbarHeadingMenu_1 = __importDefault(require("./ToolbarHeadingMenu"));
...
class ToolbarMenu extends React.Component {
    ...
    render() {
        ...
        const active_heading = [
            ...
            if ((item === null || item === void 0 ? void 0 : item.active) ? item === null || item === void 0 ? void 0 : item.active(state) : false) {
                return item;
            }
            else
                return false;
