...
exports.light = Object.assign(Object.assign({}, exports.base), { background: colors.white, text: colors.almostBlack, code: colors.lightBlack, cursor: colors.black, divider: colors.greyMid, color: colors.black, hover: colors.white10, hover20: colors.hel200, e200: colors.el200, toolbarBackground: colors.white, toolbarBackgroundT: colors.white10, linkToolbarBackground: colors.black, toolbarHoverBackground: colors.black, toolbarInput: colors.white10, toolbarItem: colors.black, tableDivider: colors.greyMid, tableSelected: colors.primary, tableSelectedBackground: "#E5F7FF", quote: colors.greyDark, codeBackground: colors.greyLight, codeBorder: colors.grey, horizontalRule: colors.greyMid, imageErrorBackground: colors.greyLight, scrollbarBackground: colors.greyLight, scrollbarThumb: colors.greyMid, inputBorder: colors.f0f0f0, iconDefault: colors.iconDefault, ModalBoxShadow: "0px 0px 10px rgba(0, 0, 0, 0.2)" });
exports.dark = Object.assign(Object.assign({}, exports.base), { background: colors.black, text: colors.white, code: colors.almostWhite, cursor: colors.white, divider: "#4E5C6E", placeholder: "#52657A", color: colors.white, hover: colors.black10, hover20: colors.hed200, e200: colors.ed200, toolbarBackground: colors.black, toolbarBackgroundT: colors.greyMid, linkToolbarBackground: colors.white, toolbarHoverBackground: colors.greyMid, toolbarInput: colors.black10, toolbarItem: colors.lightBlack, tableDivider: colors.lightBlack, tableSelected: colors.primary, tableSelectedBackground: "#002333", quote: colors.greyDark, codeBackground: colors.black, codeBorder: colors.lightBlack, codeString: "#3d8fd1", horizontalRule: colors.lightBlack, imageErrorBackground: "rgba(0, 0, 0, 0.5)", scrollbarBackground: colors.black, scrollbarThumb: colors.lightBlack, inputBorder: colors.f0f0f0, iconDefault: colors.iconDefaultDark, ModalBoxShadow: "0px 0px 10px rgba(255, 255, 255, 0.2)" });
