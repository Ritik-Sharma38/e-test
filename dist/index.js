...
class RichMarkdownEditor extends react_1.default.PureComponent {
    constructor(props) {
        ...
        this.handlePlainText = () => {
            if (!this.props.onPlainText)
                return;
            this.props.onPlainText(() => {
                var _a, _b, _c;
                return (_c = (_b = (_a = this.view) === null || _a === void 0 ? void 0 : _a.state) === null || _b === void 0 ? void 0 : _b.doc) === null || _c === void 0 ? void 0 : _c.textContent;
            });
        };
        this.handleSave = () => {
        ...
        this.toolbarMenuRef = react_1.default.createRef();
    }
    componentDidMount() {
        this.init();
...
RichMarkdownEditor.defaultProps = {
    myRef: react_1.default.createRef(),
    linkToolBarRef: react_1.default.createRef(),
    toolbarMenuRef: react_1.default.createRef(),
    defaultValue: "",
    dir: "auto",
